...
summary: 'Set up the Mailchimp newsletter block for your LV Portfolio.'
...
Create a new [embed form](https://mailchimp.com/help/add-a-signup-form-to-your-website/) and copy the form URL to your LV Portfolio config.

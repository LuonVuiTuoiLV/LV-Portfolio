---
title: "SEO settings for LV Portfolio"
summary: "Manage your LV Portfolio's SEO settings."
...
LV Portfolio automatically generates meta- and open graph tags for your pages based on the `content.js` file.

## Schema

LV Portfolio automatically generates schema tags for your pages based on the `content.js` file.
